...
const Header: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="hidden lg:block bg-gradient-to-r from-slate-900 via-blue-900 to-slate-900 text-white text-sm relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-blue-600/20 to-purple-600/20 animate-pulse"></div>
        <div className="relative max-w-7xl mx-auto flex justify-between items-center px-4 sm:px-6 lg:px-8 py-3">
          <div className="flex items-center space-x-8">
            <div className="flex items-center space-x-2 group cursor-pointer">
              <div className="p-1 bg-orange-500/20 rounded-full group-hover:bg-orange-500/30 transition-all duration-300">
                <FaPhone size={10} className="text-orange-400" />
              </div>
              <span className="group-hover:text-orange-300 transition-colors duration-300">+91-291-2720472</span>
            </div>
            <div className="flex items-center space-x-2 group cursor-pointer">
              <div className="p-1 bg-green-500/20 rounded-full group-hover:bg-green-500/30 transition-all duration-300">
                <FaEnvelope size={10} className="text-green-400" />
              </div>
              <span className="group-hover:text-green-300 transition-colors duration-300">info@earthresourcetechnology.com</span>
            </div>
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="text-xs bg-gradient-to-r from-orange-500 to-pink-500 bg-clip-text text-transparent font-semibold">
              ✨ Innovation in Mining Technology
            </div>
          </div>
        </div>
      ...
      <header className={`w-full bg-white/95 backdrop-blur-md sticky top-0 z-50 transition-all duration-500 ${
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="flex items-center justify-between px-4 sm:px-6 lg:px-8 py-3">
            ...
            {/* Ultra Modern Logo Section - Fixed Width */}
            <div className="flex-shrink-0 w-80">
              <Link to="/" className="flex items-center space-x-3 group">
                <div className="relative">
                  {/* Main Logo Container */}
            ...
            {/* Ultra Professional Navigation with Card Design */}
            <nav className="hidden lg:flex items-center justify-center flex-1">
              <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-2 shadow-lg border border-gray-200/50">
                <div className="flex items-center space-x-1">
                    ...
                    <div key={item.route} className="relative">
                      {item.hasDropdown ? (
                        <div className="relative">
                          ...
                          {/* Professional Dropdown with Card Design */}
                          <div
                            className={`absolute top-full left-0 mt-3 w-72 bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-200/50 overflow-hidden transition-all duration-300 transform ${
                              activeDropdown === item.name 
                                ? 'opacity-100 visible translate-y-0 scale-100' 
            ...
            {/* Ultra Professional Right Side Actions */}
            <div className="hidden lg:flex items-center justify-end space-x-4 w-80">
              {/* Professional Action Buttons */}
              <div className="flex items-center space-x-2 bg-white/80 backdrop-blur-sm rounded-xl p-2 shadow-md border border-gray-200/50">
                {/* Search Button */}
